...
\section{Super Strong TeleVision}
	...
	\subsection{Solution}
		...
		Once everything is set up, we simply start recording on \itl{QSSTV}, use \itl{VLC} to playback the \ttt{.wav} file to the \ttt{null-sink}, and watch the magic unfold.
	% end subsection
